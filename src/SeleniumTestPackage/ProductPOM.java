...
public class ProductPOM {
	...
	By tshirtsHover = By.xpath("(//a[@title='T-shirts'])[2]");
	...
	public void AddToCart() throws InterruptedException
	{
		...
		WebElement we = driver.findElement(hoverDress);
		actionsHover.moveToElement(we);
		...
		//hover to tshirt section
		driver.findElement(tshirtsHover).click();
		Thread.sleep(2000);
